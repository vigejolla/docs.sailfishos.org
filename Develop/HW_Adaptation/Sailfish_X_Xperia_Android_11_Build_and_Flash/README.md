...
The disk space requirement for this build is not what HADK says, but around 250GB . The download size requirement is around 50GB.
...
What works:
  ...
  - gps, bluetooth, wifi & internet sharing, mobile data, modem (SIM1 slot only), camera (photos only)
...
Known issues:
  ...
  - Camera:
    - Lens 0.6 is actually a 2.0 and vice-versa
      - This is good easy candidate for your first PR! Fixable by simply reordering labels in `/etc/dconf/db/vendor.d/jolla-camera-hw.txt`
    - https://github.com/sonyxperiadev/bug_tracker/issues/732 - happens on AOSP too
    - Can neither auto focus nor by tapping
  - Modem:
    - SIM2 slot is not enabled - https://github.com/sonyxperiadev/bug_tracker/issues/729 - happens on AOSP too
    - SIM card is sometimes not detected during boot - happens on AOSP too
      - Likely side-effect from partial fixes to https://github.com/sonyxperiadev/bug_tracker/issues/730 such as [59b41547](https://github.com/sonyxperiadev/kernel/commit/59b41547ac4866a25632d57483ab21fc40dc6468)
  - Audio
    - Incall audio is not audible, the implementation is pending a rework
